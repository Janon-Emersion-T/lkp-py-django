...
export function statusClasses(status: CaseStudyStatus): string {
  if (status === "published") {
...
export function displayStructuredContent(
  value: Record<string, unknown>,
): string {
  for (const key of ["summary", "title", "description", "text", "body"]) {
  ...
  return values || "Structured content available.";
}
