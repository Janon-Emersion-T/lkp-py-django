...
def team_dashboard_report(
    ...
    try:
        ...
        api_error(
            exc,
            "invalid_team_dashboard_request",
        )
...
def content_marketing_dashboard_report(
    request,
    preset: DashboardPeriodPreset = (
        DashboardPeriodPreset.THIS_MONTH
    ),
...
def finance_dashboard_report(
    ...
    try:
        ...
        api_error(
            exc,
            "invalid_finance_dashboard_request",
        )
...
def projects_dashboard_report(
    ...
    try:
        ...
        api_error(
            exc,
            "invalid_projects_dashboard_request",
        )
...
def sales_dashboard_report(
    ...
    try:
        ...
        api_error(
            exc,
            "invalid_sales_dashboard_request",
        )
...
def executive_dashboard_report(
    ...
    try:
        ...
        api_error(
            exc,
            "invalid_executive_dashboard_request",
        )
